<template>
  <div class="app-container">
    ...
    <el-button type="primary" plain @click="dialogChapterFormVisible = true"
      >添加章节</el-button
    >
    <!-- 添加和修改章节表单 -->
    ...
    <ul class="chanpterList">
      <li v-for="chapter in chapterVideoList" :key="chapter.id">
        ...
        <el-dialog :visible.sync="dialogVideoFormVisible" title="添加课时">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button @click="cleanVideo">取 消</el-button>
            <el-button
...
export default {
  ...
  methods: {
    ...
    updateData() {
      chapter
        .updateChapterById(this.chapter)
        .then((response) => {
          this.$message({
            type: "success",
            message: "修改成功!",
    ...
    handleVodRemove(file, fileList) {
      console.log(file);
      vod.deleteVideobyId(this.video.videoSourceId).then((response) => {
        this.$message({
          type: "success",
          message: '删除视频成功',
        });
