  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      ...
      <section class="path-wrap txtOf hLh30">
          ...
          \
          <span class="c-333 fsize14">{{ course.subjectOneList }}</span>
          \
          <span class="c-333 fsize14">{{ course.subjectTwoList }}</span>
      </section>
      <!-- /课程所属分类 结束 -->
      ...
      <div>
          <article class="c-v-pic-wrap" style="height: 357px;">
              <section id="videoPlay" class="p-h-video-box">
                  <img :src="course.cover" :alt="course.title" class="dis c-v-pic" width="640px" height="358px">
              </section>
          </article>
...
export default {
  asyncData({ params, error }) {
    return course.getById(params.id).then(response => {
      ...
      return { 
        course: response.data.data.courseFrontInfoVo,
